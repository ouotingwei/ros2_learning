...
public:
	...
	MinimalPublisher() : (" minimal_publisher"), count_(0) {
...
int main(int argc, char *argv[]){
	...
	rclcpp::spin(std::make_shared<MinimalPublisher>());	//starts processing data from the node, including callbacks from the timer
	rclcpp::shutdown();
	return 0;
}
